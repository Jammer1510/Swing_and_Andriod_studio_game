...
public class Game10Screen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newGame.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                startActivity(new Intent(Game10Screen.this, GameScreen.class));
            }
        });
        ...
        endGame.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                ...
                iv6.setImageResource(image20);
                iv7.setImageResource(image21);
                iv8.setImageResource(image22);
                iv9.setImageResource(image23);
                iv10.setImageResource(image24);
    ...
    private void gameOver () {
        if (iv1.getVisibility() == View.INVISIBLE &&
            ...
            loadHighScores();
            if (checkHighScore(10) == false) {
                //Toast.makeText(getActivity(), "Game Over", Toast.LENGTH_SHORT).show();
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Game10Screen.this);
                alertDialogBuilder
                ...
                final EditText nameInput = new EditText(Game10Screen.this);
                int maxLength = 8;
    ...
    public void loadHighScores(){
        ...
        if (file.exists()){
            try{
                ...
                Toast.makeText(Game10Screen.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onConfigurationChanged(Configuration newConfig) {
        ...
        if(newConfig.orientation==Configuration.ORIENTATION_LANDSCAPE){
            ...
            iv9.getLayoutParams().width = 116;
            iv10.getLayoutParams().width = 116;
            ...
            iv9.getLayoutParams().height = 152;
            iv10.getLayoutParams().height = 152;
        }else{
            ...
            iv9.getLayoutParams().width = 216;
            iv10.getLayoutParams().width = 216;
            ...
            iv9.getLayoutParams().height = 252;
            iv10.getLayoutParams().height = 252;
        }
    }
}
